...
export default function on_select(input: validationInput): validationOutput {
  ...
  - **condition REQUIRED_CONTEXT_DOMAIN.2**: every element of $.context.domain must be in ["ONDC:RET10", "ONDC:RET11", "ONDC:RET12", "ONDC:RET13", "ONDC:RET14", "ONDC:RET15", "ONDC:RET16", "ONDC:RET17", "ONDC:RET18", "ONDC:RET19"]`,
        ...
        function REQUIRED_MESSAGE_FULFILLMENTSONDCORGCATEGORY(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_FULFILLMENTSONDCORGCATEGORY**: $.message.order.fulfillments[*]['@ondc/org/category'] must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_FULFILLMENTSONDCORGCATEGORY_21(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_FULFILLMENTSONDCORGCATEGORY_21**: $.message.order.fulfillments[*]['@ondc/org/category'] must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CODE(
            ...
            for (const testObj of scope) {
                ...
                const enumList = ["Serviceable", "Non-Serviceable"];
  ...
  - **condition REQUIRED_MESSAGE_BREAKUPONDCORGTITLE_TYPE.2**: every element of $.message.order.quote.breakup[*]['@ondc/org/title_type'] must be in ["item", "delivery", "packing", "tax", "misc", "discount", "discount_f", "tax_f", "0"]`,
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_CODE**: every element of $.message.order.fulfillments[*].state.descriptor.code must be in ["Serviceable", "Non-Serviceable"]
	...
	> - **condition B**: $.message.order.quote.breakup[*].item.quantity.maximum.count must **not** be present in the payload`,
        ...
        const testFunctions: testFunctionArray = [
            ...
            REQUIRED_MESSAGE_FULFILLMENTSONDCORGCATEGORY,
            REQUIRED_MESSAGE_TRACKING,
            REQUIRED_MESSAGE_FULFILLMENTSONDCORGCATEGORY_21,
