                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_23**: $.message.order.items[*].time.label must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_24**: $.message.order.items[*].time.duration must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_25**: $.message.order.provider.id must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_26**: $.message.order.provider.descriptor.name must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_29**: $.message.order.fulfillments[*].stops[*].location.gps must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_30**: $.message.order.fulfillments[*].id must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_43**: $.message.order.items[*].category_ids[*] must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_44**: $.message.order.provider.time.range.start must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_45**: $.message.order.provider.time.range.end must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_47**: $.message.order.quote.breakup[*].item.price.currency must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_49**: $.message.order.quote.breakup[*].item.quantity.selected.count must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_50**: $.message.order.cancellation_terms[*].external_ref.url must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_51**: $.message.order.cancellation_terms[*].external_ref.mimetype must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_52**: $.message.order.created_at must be present in the payload`,
                                },
                            ];
                        }
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition validate_attribute_53**: $.message.order.updated_at must be present in the payload`,
                                },
                            ];
                        }
