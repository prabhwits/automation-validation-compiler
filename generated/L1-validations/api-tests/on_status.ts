...
export default function on_status(input: validationInput): validationOutput {
  ...
  - **condition REQUIRED_MESSAGE_CODE.2**: every element of $.message.order.fulfillments[*].state.descriptor.code must be in ["Pending", "Packed", "Pickup-approved", "Pickup-rejected", "Order-picked-up", "Out-for-delivery", "Order-delivered", "RTO-Initiated", "RTO-Delivered", "RTO-Disposed"]`,
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TYPE**: $.message.order.fulfillments[*].type must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_ID_35**: $.message.order.fulfillments[*].start.location.id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_36**: $.message.order.fulfillments[*].start.location.descriptor.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_LOCALITY_38(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_LOCALITY_38**: $.message.order.fulfillments[*].start.location.address.locality must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CITY_39(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CITY_39**: $.message.order.fulfillments[*].start.location.address.city must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_AREA_CODE_40(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_AREA_CODE_40**: $.message.order.fulfillments[*].start.location.address.area_code must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_41**: $.message.order.fulfillments[*].start.location.address.state must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_42**: $.message.order.fulfillments[*].start.instructions.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_PHONE_45(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PHONE_45**: $.message.order.fulfillments[*].start.contact.phone must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_57**: $.message.order.fulfillments[*].end.person.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_PHONE_58(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PHONE_58**: $.message.order.fulfillments[*].end.contact.phone must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_EMAIL**: $.message.order.fulfillments[*].end.contact.email must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_START_60(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_START_60**: $.message.order.fulfillments[*].end.time.range.start must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_END_61(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_END_61**: $.message.order.fulfillments[*].end.time.range.end must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_TIMESTAMP_62(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TIMESTAMP_62**: $.message.order.fulfillments[*].end.time.timestamp must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_COUNT_66(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COUNT_66**: $.message.order.quote.breakup[*]['@ondc/org/item_quantity'].count must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_BREAKUPONDCORGTITLE_TYPE.2**: every element of $.message.order.quote.breakup[*]['@ondc/org/title_type'] must be in ["item", "delivery", "packing", "tax", "misc", "discount", "discount_f", "tax_f", "0"]`,
        ...
        function REQUIRED_MESSAGE_CURRENCY_69(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CURRENCY_69**: $.message.order.quote.breakup[*].price.currency must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_VALUE_70**: $.message.order.quote.breakup[*].price.value must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CURRENCY_74**: $.message.order.payment.params.currency must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_STATUS.2**: every element of $.message.order.payment.status must be in ["PAID", "NOT-PAID"]`,
        ...
        function REQUIRED_MESSAGE_TYPE_77(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TYPE_77**: all of the following sub conditions must be met:
  ...
  - **condition REQUIRED_MESSAGE_SETTLEMENT_TYPE.2**: every element of $.message.order.payment['@ondc/org/settlement_details'][*].settlement_type must be in ["upi", "neft", "rtgs", "wallet", "netbanking", "paylater"]`,
        ...
        function REQUIRED_MESSAGE_CREATED_AT_83(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CREATED_AT_83**: $.message.order.created_at must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_UPDATED_AT_84(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_UPDATED_AT_84**: $.message.order.updated_at must be present in the payload`,
                        },
                    ];
                }
	...
	> - **condition B**: $.message.order.fulfillments[*].state.descriptor.code must **not** be present in the payload`,
        ...
        function VALID_ENUM_MESSAGE_CODE_3(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_CODE_3**: every element of $.message.order.fulfillments[*].end.instructions.code must be in ["1", "2", "3", "4"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_TYPE**: every element of $.message.order.payment.type must be in ["ON-ORDER", "ON-FULFILLMENT", "POST-FULFILLMENT"]
	...
	> - **condition B**: $.message.order.state must **not** be present in the payload`,
        ...
        const testFunctions: testFunctionArray = [
            ...
            REQUIRED_MESSAGE_LOCALITY_38,
            REQUIRED_MESSAGE_CITY_39,
            REQUIRED_MESSAGE_AREA_CODE_40,
            REQUIRED_MESSAGE_STATE_41,
            REQUIRED_MESSAGE_NAME_42,
            REQUIRED_MESSAGE_SHORT_DESC,
            REQUIRED_MESSAGE_LONG_DESC,
            REQUIRED_MESSAGE_PHONE_45,
            ...
            REQUIRED_MESSAGE_CREATED_AT_83,
            REQUIRED_MESSAGE_UPDATED_AT_84,
            VALID_ENUM_CONTEXT_DOMAIN,
            VALID_ENUM_MESSAGE_CODE,
            VALID_ENUM_MESSAGE_CODE_3,
