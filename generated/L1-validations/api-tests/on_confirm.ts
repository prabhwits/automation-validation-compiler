...
export default function on_confirm(input: validationInput): validationOutput {
  ...
  - **condition REQUIRED_MESSAGE_STATE.2**: every element of $.message.order.state must be in ["Created", "Accepted", "In-progress", "Completed", "Cancelled"]`,
        ...
        function REQUIRED_MESSAGE_STATE_24(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_24**: $.message.order.billing.address.state must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_PROVIDER_ID(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
            ...
            for (const testObj of scope) {
                ...
                const attr = payloadUtils.getJsonPath(
                    testObj,
                    "$.message.order.fulfillments[*].provider_id",
                );
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PROVIDER_ID**: $.message.order.fulfillments[*].provider_id must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_TYPE.2**: every element of $.message.order.fulfillments[*].type must be in ["Delivery", "Self-Pickup", "Delivery and Self-Pickup"]`,
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_ID_38**: $.message.order.fulfillments[*].start.location.id must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_NAME_39(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_39**: $.message.order.fulfillments[*].start.location.descriptor.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_GPS_41(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_GPS_41**: $.message.order.fulfillments[*].end.location.gps must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_NAME_42(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_42**: $.message.order.fulfillments[*].end.location.address.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_BUILDING_43(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_BUILDING_43**: $.message.order.fulfillments[*].end.location.address.building must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_LOCALITY_44(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_LOCALITY_44**: $.message.order.fulfillments[*].end.location.address.locality must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CITY_45(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CITY_45**: $.message.order.fulfillments[*].end.location.address.city must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_STATE_46(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_46**: $.message.order.fulfillments[*].end.location.address.state must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_COUNTRY_47(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COUNTRY_47**: $.message.order.fulfillments[*].end.location.address.country must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_AREA_CODE_48(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_AREA_CODE_48**: $.message.order.fulfillments[*].end.location.address.area_code must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_NAME_49(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_49**: $.message.order.fulfillments[*].end.person.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_PHONE_50(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PHONE_50**: $.message.order.fulfillments[*].end.contact.phone must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_EMAIL_51(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_EMAIL_51**: $.message.order.fulfillments[*].end.contact.email must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COUNT_55**: $.message.order.quote.breakup[*]['@ondc/org/item_quantity'].count must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_TITLE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TITLE**: $.message.order.quote.breakup[*].title must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_BREAKUPONDCORGTITLE_TYPE.2**: every element of $.message.order.quote.breakup[*]['@ondc/org/title_type'] must be in ["item", "delivery", "packing", "tax", "misc", "discount", "discount_f", "tax_f", "0"]`,
        ...
        function REQUIRED_MESSAGE_CURRENCY_58(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CURRENCY_58**: $.message.order.quote.breakup[*].price.currency must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_VALUE_59(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_VALUE_59**: $.message.order.quote.breakup[*].price.value must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CURRENCY_60(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CURRENCY_60**: $.message.order.quote.breakup[*].price.currency must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_VALUE_61(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_VALUE_61**: $.message.order.quote.breakup[*].price.value must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_URI**: $.message.order.payment.uri must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_TL_METHOD(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TL_METHOD**: $.message.order.payment.tl_method must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CURRENCY_66**: $.message.order.payment.params.currency must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_STATUS.2**: every element of $.message.order.payment.status must be in ["PAID", "NOT-PAID"]`,
        ...
        function REQUIRED_MESSAGE_TYPE_68(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TYPE_68**: all of the following sub conditions must be met:
  ...
  - **condition REQUIRED_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_TYPE.2**: every element of $.message.order.payment['@ondc/org/buyer_app_finder_fee_type'] must be in ["percent", "amount"]`,
        ...
        function REQUIRED_MESSAGE_CREATED_AT_80(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CREATED_AT_80**: $.message.order.created_at must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_UPDATED_AT_81(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_UPDATED_AT_81**: $.message.order.updated_at must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_ID_82(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_ID_82**: $.message.order.offers[*].id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_TYPE**: every element of $.message.order.fulfillments[*].type must be in ["Delivery", "Self-Pickup", "Delivery and Self-Pickup"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_CODE**: every element of $.message.order.fulfillments[*].state.descriptor.code must be in ["Pending", "Packed", "Pickup-approved", "Pickup-rejected", "Order-picked-up", "Out-for-delivery", "Order-delivered", "RTO-Initiated", "RTO-Delivered", "RTO-Disposed"]
	...
	> - **condition B**: $.message.order.quote.breakup[*].item.quantity.available.count must **not** be present in the payload`,
        ...
        function VALID_ENUM_MESSAGE_COUNT_6(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_COUNT_6**: every element of $.message.order.quote.breakup[*].item.quantity.maximum.count must be in ["0", "10"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_CODE_7**: every element of $.message.order.cancellation_terms[*].fulfillment_state.descriptor.code must be in ["Pending", "Packed", "Pickup-approved", "Pickup-rejected", "Order-picked-up", "Out-for-delivery", "Order-delivered", "RTO-Initiated", "RTO-Delivered", "RTO-Disposed"]
	...
	> - **condition B**: $.message.order.state must **not** be present in the payload`,
        ...
        const testFunctions: testFunctionArray = [
            ...
            REQUIRED_MESSAGE_GPS_41,
            REQUIRED_MESSAGE_NAME_42,
            REQUIRED_MESSAGE_BUILDING_43,
            REQUIRED_MESSAGE_LOCALITY_44,
            REQUIRED_MESSAGE_CITY_45,
            REQUIRED_MESSAGE_STATE_46,
            REQUIRED_MESSAGE_COUNTRY_47,
            REQUIRED_MESSAGE_AREA_CODE_48,
            REQUIRED_MESSAGE_NAME_49,
            REQUIRED_MESSAGE_PHONE_50,
            REQUIRED_MESSAGE_EMAIL_51,
            REQUIRED_MESSAGE_CURRENCY,
            REQUIRED_MESSAGE_VALUE,
            REQUIRED_MESSAGE_BREAKUPONDCORGITEM_ID,
            REQUIRED_MESSAGE_COUNT_55,
            REQUIRED_MESSAGE_TITLE,
            REQUIRED_MESSAGE_BREAKUPONDCORGTITLE_TYPE,
            REQUIRED_MESSAGE_CURRENCY_58,
            REQUIRED_MESSAGE_VALUE_59,
            REQUIRED_MESSAGE_CURRENCY_60,
            REQUIRED_MESSAGE_VALUE_61,
            REQUIRED_MESSAGE_TTL,
            REQUIRED_MESSAGE_URI,
            REQUIRED_MESSAGE_TL_METHOD,
            REQUIRED_MESSAGE_AMOUNT,
            REQUIRED_MESSAGE_CURRENCY_66,
            REQUIRED_MESSAGE_STATUS,
            REQUIRED_MESSAGE_TYPE_68,
            ...
            REQUIRED_MESSAGE_CREATED_AT_80,
            REQUIRED_MESSAGE_UPDATED_AT_81,
            REQUIRED_MESSAGE_ID_82,
