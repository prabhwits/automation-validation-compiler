...
export default function on_cancel(input: validationInput): validationOutput {
  ...
  - **condition REQUIRED_MESSAGE_STATE.2**: every element of $.message.order.state must be in ["Cancelled"]`,
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_ID_18**: $.message.order.provider.locations[*].id must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_STATE_23(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_23**: $.message.order.billing.address.state must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_TYPE.2**: every element of $.message.order.fulfillments[*].type must be in ["Delivery", "Self-Pickup", "Delivery and Self-Pickup"]`,
        ...
        function REQUIRED_MESSAGE_LOCALITY_39(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_LOCALITY_39**: $.message.order.fulfillments[*].start.location.address.locality must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_AREA_CODE_41(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_AREA_CODE_41**: $.message.order.fulfillments[*].start.location.address.area_code must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_EMAIL_43(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_EMAIL_43**: $.message.order.fulfillments[*].start.contact.email must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_PHONE_44(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PHONE_44**: $.message.order.fulfillments[*].start.contact.phone must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_NAME_45(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_45**: $.message.order.fulfillments[*].end.person.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_EMAIL_46(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_EMAIL_46**: $.message.order.fulfillments[*].end.contact.email must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PHONE_47**: $.message.order.fulfillments[*].end.contact.phone must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_GPS_48(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_GPS_48**: $.message.order.fulfillments[*].end.location.gps must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_49**: $.message.order.fulfillments[*].end.location.address.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_BUILDING_50(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_BUILDING_50**: $.message.order.fulfillments[*].end.location.address.building must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_LOCALITY_51(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_LOCALITY_51**: $.message.order.fulfillments[*].end.location.address.locality must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CITY_52(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CITY_52**: $.message.order.fulfillments[*].end.location.address.city must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_STATE_53(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_53**: $.message.order.fulfillments[*].end.location.address.state must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_COUNTRY_54(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COUNTRY_54**: $.message.order.fulfillments[*].end.location.address.country must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_AREA_CODE_55(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_AREA_CODE_55**: $.message.order.fulfillments[*].end.location.address.area_code must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COUNT_59**: $.message.order.quote.breakup[*]['@ondc/org/item_quantity'].count must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_BREAKUPONDCORGTITLE_TYPE.2**: every element of $.message.order.quote.breakup[*]['@ondc/org/title_type'] must be in ["item", "delivery", "packing", "tax", "misc", "discount", "discount_f", "tax_f", "0"]`,
        ...
        function REQUIRED_MESSAGE_CURRENCY_62(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CURRENCY_62**: $.message.order.quote.breakup[*].price.currency must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_VALUE_63(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_VALUE_63**: $.message.order.quote.breakup[*].price.value must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CURRENCY_70(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CURRENCY_70**: $.message.order.payment.params.currency must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_STATUS.2**: every element of $.message.order.payment.status must be in ["PAID", "NOT-PAID"]`,
        ...
        function REQUIRED_MESSAGE_TYPE_73(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TYPE_73**: all of the following sub conditions must be met:
  ...
  - **condition REQUIRED_MESSAGE_SETTLEMENT_TYPE.2**: every element of $.message.order.payment['@ondc/org/settlement_details'][*].settlement_type must be in ["upi", "neft", "rtgs", "wallet", "netbanking", "paylater"]`,
        ...
        function REQUIRED_MESSAGE_ID_86(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_ID_86**: $.message.order.id must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CREATED_AT_87(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CREATED_AT_87**: $.message.order.created_at must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_UPDATED_AT_88(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_UPDATED_AT_88**: $.message.order.updated_at must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_COLLECTED_BY_89(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COLLECTED_BY_89**: all of the following sub conditions must be met:
  ...
  - **condition REQUIRED_MESSAGE_COLLECTED_BY_89.2**: every element of $.message.order.payment.collected_by must be in ["BAP", "BPP"]`,
        ...
        function REQUIRED_MESSAGE_END(
            ...
            for (const testObj of scope) {
                ...
                const attr = payloadUtils.getJsonPath(
                    testObj,
                    "$.message.order.payment.time.range.end",
                );
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_END**: $.message.order.payment.time.range.end must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_STATE**: every element of $.message.order.state must be in ["Cancelled"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_CODE**: every element of $.message.order.fulfillments[*].state.descriptor.code must be in ["Cancelled", "RTO-Initiated", "RTO-Delivered", "RTO-Disposed"]
	...
	> - **condition B**: $.message.order.payment['@ondc/org/settlement_basis'] must **not** be present in the payload`,
        ...
        const testFunctions: testFunctionArray = [
            ...
            REQUIRED_MESSAGE_LOCALITY_39,
            REQUIRED_MESSAGE_CITY_40,
            REQUIRED_MESSAGE_AREA_CODE_41,
            REQUIRED_MESSAGE_STATE_42,
            REQUIRED_MESSAGE_EMAIL_43,
            REQUIRED_MESSAGE_PHONE_44,
            REQUIRED_MESSAGE_NAME_45,
            REQUIRED_MESSAGE_EMAIL_46,
            REQUIRED_MESSAGE_PHONE_47,
            REQUIRED_MESSAGE_GPS_48,
            REQUIRED_MESSAGE_NAME_49,
            REQUIRED_MESSAGE_BUILDING_50,
            REQUIRED_MESSAGE_LOCALITY_51,
            REQUIRED_MESSAGE_CITY_52,
            REQUIRED_MESSAGE_STATE_53,
            REQUIRED_MESSAGE_COUNTRY_54,
            REQUIRED_MESSAGE_AREA_CODE_55,
            ...
            REQUIRED_MESSAGE_CURRENCY_62,
            REQUIRED_MESSAGE_VALUE_63,
            ...
            REQUIRED_MESSAGE_ID_86,
            REQUIRED_MESSAGE_CREATED_AT_87,
            REQUIRED_MESSAGE_UPDATED_AT_88,
            REQUIRED_MESSAGE_COLLECTED_BY_89,
