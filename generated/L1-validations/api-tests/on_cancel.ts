...
export default function on_cancel(input: validationInput): validationOutput {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_category_ids_22**: $.message.order.items[*].category_ids[*] must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_label_23**: $.message.order.items[*].time.label must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_duration_24**: $.message.order.items[*].time.duration must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_id_25**: $.message.order.provider.id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_name_26**: $.message.order.provider.descriptor.name must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_url_27**: $.message.order.provider.descriptor.images[*].url must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_start_28**: $.message.order.provider.time.range.start must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_end_29**: $.message.order.provider.time.range.end must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_id_30**: $.message.order.fulfillments[*].id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_type_31**: $.message.order.fulfillments[*].type must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_value_32**: $.message.order.quote.price.value must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_currency_33**: $.message.order.quote.price.currency must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_title_34**: $.message.order.quote.breakup[*].title must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_id_35**: $.message.order.payments[*].id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_collected_by_36**: $.message.order.payments[*].collected_by must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_status_37**: $.message.order.payments[*].status must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_type_38**: $.message.order.payments[*].type must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_bank_code_39**: $.message.order.payments[*].params.bank_code must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_bank_account_number_40**: $.message.order.payments[*].params.bank_account_number must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_url_41**: $.message.order.cancellation_terms[*].external_ref.url must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_mimetype_42**: $.message.order.cancellation_terms[*].external_ref.mimetype must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_cancelled_by_43**: $.message.order.cancellation.cancelled_by must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_time_44**: $.message.order.cancellation.time must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_1**: every element of $.context.action must be in ["on_cancel"]
	...
	> - **condition B**: $.message.order.payments[*].tags[*].descriptor.code must **not** be present in the payload`,
        ...
        const testFunctions: testFunctionArray = [
            ...
            validate_category_ids_22,
            validate_label_23,
            validate_duration_24,
            validate_id_25,
            validate_name_26,
            validate_url_27,
            validate_start_28,
            ...
            validate_type_31,
            validate_value_32,
            validate_currency_33,
            validate_title_34,
            validate_id_35,
            validate_collected_by_36,
            validate_status_37,
            validate_type_38,
            validate_bank_code_39,
            validate_bank_account_number_40,
            validate_url_41,
            validate_mimetype_42,
            validate_cancelled_by_43,
            validate_time_44,
            validate_enum_1,
            validate_enum_2,
            validate_enum_4,
