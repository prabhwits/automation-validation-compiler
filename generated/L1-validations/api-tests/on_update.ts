...
export default function on_update(input: validationInput): validationOutput {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COUNT**: $.message.order.items[*].quantity.count must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_FULFILLMENT_ID**: $.message.order.items[*].fulfillment_id must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_BREAKUPONDCORGTITLE_TYPE.2**: every element of $.message.order.quote.breakup[*]['@ondc/org/title_type'] must be in ["item", "delivery", "packing", "tax", "misc", "discount", "discount_f", "tax_f", "0"]`,
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME**: $.message.order.billing.address.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_STATE_25(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_25**: $.message.order.billing.address.state must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_FULFILLMENTSONDCORGPROVIDER_NAME(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_FULFILLMENTSONDCORGPROVIDER_NAME**: $.message.order.fulfillments[*]['@ondc/org/provider_name'] must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_TYPE.2**: every element of $.message.order.fulfillments[*].type must be in ["Cancel", "Delivery", "Return"]`,
        ...
        function REQUIRED_MESSAGE_FULFILLMENTSONDCORGTAT(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_FULFILLMENTSONDCORGTAT**: $.message.order.fulfillments[*]['@ondc/org/TAT'] must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_ID_36(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_ID_36**: $.message.order.fulfillments[*].start.location.id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_37**: $.message.order.fulfillments[*].start.location.descriptor.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CITY_40(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CITY_40**: $.message.order.fulfillments[*].start.location.address.city must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_STATE_42(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_42**: $.message.order.fulfillments[*].start.location.address.state must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CODE_43(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CODE_43**: $.message.order.fulfillments[*].start.instructions.code must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_44**: $.message.order.fulfillments[*].start.instructions.name must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_SHORT_DESC**: $.message.order.fulfillments[*].start.instructions.short_desc must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_LONG_DESC(
            ...
            for (const testObj of scope) {
                ...
                const attr = payloadUtils.getJsonPath(
                    testObj,
                    "$.message.order.fulfillments[*].start.instructions.long_desc",
                );
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_LONG_DESC**: $.message.order.fulfillments[*].start.instructions.long_desc must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_PHONE_47(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PHONE_47**: $.message.order.fulfillments[*].start.contact.phone must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_EMAIL_48(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_EMAIL_48**: $.message.order.fulfillments[*].start.contact.email must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TIMESTAMP**: $.message.order.fulfillments[*].start.time.timestamp must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_GPS_52(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_GPS_52**: $.message.order.fulfillments[*].end.location.gps must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_NAME_53(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_53**: $.message.order.fulfillments[*].end.location.address.name must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_BUILDING**: $.message.order.fulfillments[*].end.location.address.building must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_LOCALITY_55(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_LOCALITY_55**: $.message.order.fulfillments[*].end.location.address.locality must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CITY_56(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CITY_56**: $.message.order.fulfillments[*].end.location.address.city must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_STATE_57(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_57**: $.message.order.fulfillments[*].end.location.address.state must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_COUNTRY_58(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COUNTRY_58**: $.message.order.fulfillments[*].end.location.address.country must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_AREA_CODE_59(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_AREA_CODE_59**: $.message.order.fulfillments[*].end.location.address.area_code must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_NAME_60(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_60**: $.message.order.fulfillments[*].end.person.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_PHONE_61(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PHONE_61**: $.message.order.fulfillments[*].end.contact.phone must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_EMAIL_62(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_EMAIL_62**: $.message.order.fulfillments[*].end.contact.email must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_START_63(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_START_63**: $.message.order.fulfillments[*].end.time.range.start must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_END_64(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_END_64**: $.message.order.fulfillments[*].end.time.range.end must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_TIMESTAMP_65(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TIMESTAMP_65**: $.message.order.fulfillments[*].end.time.timestamp must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_AMOUNT(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_AMOUNT**: $.message.order.payment.params.amount must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CURRENCY_67(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CURRENCY_67**: $.message.order.payment.params.currency must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_TRANSACTION_ID(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_TRANSACTION_ID**: $.message.order.payment.params.transaction_id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COLLECTED_BY**: all of the following sub conditions must be met:
  ...
  - **condition REQUIRED_MESSAGE_COLLECTED_BY.2**: every element of $.message.order.payment.collected_by must be in ["BAP", "BPP"]`,
        ...
        function REQUIRED_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_TYPE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_TYPE**: all of the following sub conditions must be met:
  ...
  - **condition REQUIRED_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_TYPE.2**: every element of $.message.order.payment['@ondc/org/buyer_app_finder_fee_type'] must be in ["percent", "amount"]`,
        ...
        function REQUIRED_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_AMOUNT(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_AMOUNT**: $.message.order.payment['@ondc/org/buyer_app_finder_fee_amount'] must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_SETTLEMENT_COUNTERPARTY(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_SETTLEMENT_COUNTERPARTY**: $.message.order.payment['@ondc/org/settlement_details'][*].settlement_counterparty must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_SETTLEMENT_PHASE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_SETTLEMENT_PHASE**: $.message.order.payment['@ondc/org/settlement_details'][*].settlement_phase must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_SETTLEMENT_TYPE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_SETTLEMENT_TYPE**: all of the following sub conditions must be met:
  ...
  - **condition REQUIRED_MESSAGE_SETTLEMENT_TYPE.2**: every element of $.message.order.payment['@ondc/org/settlement_details'][*].settlement_type must be in ["upi", "neft", "rtgs", "wallet", "netbanking", "paylater"]`,
        ...
        function REQUIRED_MESSAGE_BENEFICIARY_NAME(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_BENEFICIARY_NAME**: $.message.order.payment['@ondc/org/settlement_details'][*].beneficiary_name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_SETTLEMENT_BANK_ACCOUNT_NO(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_SETTLEMENT_BANK_ACCOUNT_NO**: $.message.order.payment['@ondc/org/settlement_details'][*].settlement_bank_account_no must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_SETTLEMENT_IFSC_CODE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_SETTLEMENT_IFSC_CODE**: $.message.order.payment['@ondc/org/settlement_details'][*].settlement_ifsc_code must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_BANK_NAME(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_BANK_NAME**: $.message.order.payment['@ondc/org/settlement_details'][*].bank_name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_BRANCH_NAME(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_BRANCH_NAME**: $.message.order.payment['@ondc/org/settlement_details'][*].branch_name must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CREATED_AT**: $.message.order.created_at must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_UPDATED_AT_83(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_UPDATED_AT_83**: $.message.order.updated_at must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_CODE**: every element of $.message.order.fulfillments[*].state.descriptor.code must be in ["Accepted", "Cancelled", "Pending", "Order-delivered", "Return_Initiated", "Return_Pick_Failed", "Return_Approved", "Return_Picked", "Return_Delivered", "Liquidated", "Return_Rejected"]
	...
	> - **condition B**: $.message.order.fulfillments[*].type must **not** be present in the payload`,
        ...
        function VALID_ENUM_MESSAGE_CODE_4(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_CODE_4**: every element of $.message.order.fulfillments[*].end.instructions.code must be in ["1", "2", "3", "4"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_BREAKUPONDCORGTITLE_TYPE**: every element of $.message.order.quote.breakup[*]['@ondc/org/title_type'] must be in ["item", "delivery", "packing", "tax", "misc", "discount", "discount_f", "tax_f", "0"]
	...
	> - **condition B**: $.message.order.quote.breakup[*]['@ondc/org/title_type'] must **not** be present in the payload`,
        ...
        function VALID_ENUM_MESSAGE_COUNT(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_COUNT**: every element of $.message.order.quote.breakup[*].item.quantity.available.count must be in ["0", "99"]
	...
	> - **condition B**: $.message.order.quote.breakup[*].item.quantity.available.count must **not** be present in the payload`,
        ...
        function VALID_ENUM_MESSAGE_COUNT_7(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_COUNT_7**: every element of $.message.order.quote.breakup[*].item.quantity.maximum.count must be in ["0", "10"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_TYPE_8**: every element of $.message.order.payment.type must be in ["ON-ORDER", "ON-FULFILLMENT", "POST-FULFILLMENT"]
	...
	> - **condition B**: $.message.order.payment['@ondc/org/settlement_details'][*].settlement_type must **not** be present in the payload`,
        ...
        function VALID_ENUM_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_TYPE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_TYPE**: every element of $.message.order.payment['@ondc/org/buyer_app_finder_fee_type'] must be in ["percent", "amount"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_COLLECTED_BY**: every element of $.message.order.payment.collected_by must be in ["BAP", "BPP"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_STATUS**: every element of $.message.order.payment.status must be in ["PAID", "NOT-PAID"]
	...
	> - **condition B**: $.message.order.payment.status must **not** be present in the payload`,
        ...
        function VALID_ENUM_MESSAGE_PAYMENTONDCORGSETTLEMENT_BASIS(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_PAYMENTONDCORGSETTLEMENT_BASIS**: every element of $.message.order.payment['@ondc/org/settlement_basis'] must be in ["shipment", "delivery", "return_window_expiry"]
	...
	> - **condition B**: $.message.order.state must **not** be present in the payload`,
        ...
        const testFunctions: testFunctionArray = [
            ...
            REQUIRED_MESSAGE_GPS_52,
            REQUIRED_MESSAGE_NAME_53,
            REQUIRED_MESSAGE_BUILDING,
            REQUIRED_MESSAGE_LOCALITY_55,
            REQUIRED_MESSAGE_CITY_56,
            REQUIRED_MESSAGE_STATE_57,
            REQUIRED_MESSAGE_COUNTRY_58,
            REQUIRED_MESSAGE_AREA_CODE_59,
            REQUIRED_MESSAGE_NAME_60,
            REQUIRED_MESSAGE_PHONE_61,
            REQUIRED_MESSAGE_EMAIL_62,
            REQUIRED_MESSAGE_START_63,
            REQUIRED_MESSAGE_END_64,
            REQUIRED_MESSAGE_TIMESTAMP_65,
            REQUIRED_MESSAGE_AMOUNT,
            REQUIRED_MESSAGE_CURRENCY_67,
            REQUIRED_MESSAGE_TRANSACTION_ID,
            REQUIRED_MESSAGE_STATUS,
            REQUIRED_MESSAGE_TYPE_70,
            REQUIRED_MESSAGE_COLLECTED_BY,
            REQUIRED_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_TYPE,
            REQUIRED_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_AMOUNT,
            REQUIRED_MESSAGE_SETTLEMENT_COUNTERPARTY,
            REQUIRED_MESSAGE_SETTLEMENT_PHASE,
            REQUIRED_MESSAGE_SETTLEMENT_TYPE,
            REQUIRED_MESSAGE_BENEFICIARY_NAME,
            REQUIRED_MESSAGE_SETTLEMENT_BANK_ACCOUNT_NO,
            REQUIRED_MESSAGE_SETTLEMENT_IFSC_CODE,
            REQUIRED_MESSAGE_BANK_NAME,
            REQUIRED_MESSAGE_BRANCH_NAME,
            REQUIRED_MESSAGE_CREATED_AT,
            REQUIRED_MESSAGE_UPDATED_AT_83,
            VALID_ENUM_CONTEXT_DOMAIN,
            VALID_ENUM_MESSAGE_CODE,
            VALID_ENUM_MESSAGE_TYPE,
            VALID_ENUM_MESSAGE_CODE_4,
            VALID_ENUM_MESSAGE_BREAKUPONDCORGTITLE_TYPE,
            VALID_ENUM_MESSAGE_COUNT,
            VALID_ENUM_MESSAGE_COUNT_7,
            VALID_ENUM_MESSAGE_TYPE_8,
            VALID_ENUM_MESSAGE_SETTLEMENT_TYPE,
            VALID_ENUM_MESSAGE_PAYMENTONDCORGBUYER_APP_FINDER_FEE_TYPE,
            VALID_ENUM_MESSAGE_COLLECTED_BY,
            VALID_ENUM_MESSAGE_STATUS,
            VALID_ENUM_MESSAGE_PAYMENTONDCORGSETTLEMENT_BASIS,
